...
---@class WarehouseControllerApp
local M = {}

---Run the warehouse controller event loop.
---@return nil
function M.run()
  ...
  local runtime = require("src.app.runtime")
  local executorLib = require("src.app.executor")
  local persistence = require("src.infra.persistence")
  local networkLib = require("src.infra.network")
  local snapshotLib = require("src.app.snapshot")
  local stationLib = require("src.infra.station")
  local tables = require("src.util.tables")
  local ui = require("src.ui.controller")
