...
local VERSION = "0.1.0"
local SOURCE_BASE_URL = "https://raw.githubusercontent.com/wradley/cc-tweaked-programs/refs/heads/main/programs/inventory-coordinator/0.1.0"
...
local function startupContents()
  return table.concat({
    ...
    "end",
    'local startupPath = fs.combine(programRoot, fs.combine(version, "startup.lua"))',
    'if not fs.exists(startupPath) then',
    '  error("missing installed startup: " .. startupPath, 0)',
    "end",
